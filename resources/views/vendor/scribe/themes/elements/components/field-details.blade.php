...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3 custom-border-none">
        ...
        <div class="sl-flex sl-items-center sl-max-w-full">
            ...
            @unless($isArrayBody)
                ...
                @if($required)
                    ...
                    <span class="sl-ml-2 custom-require">required</span>
                @endif
            @endunless
        </div>
        @if($description)
        ...
        @if(!$hasChildren && !is_null($example) && $example !== '')
            <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-baseline sl-text-muted">
                ...
                <div class="sl-flex sl-flex-1 sl-flex-wrap" style="gap: 4px;">
                    <div class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border custom-example-variable">
