<div id="sidebar" class="sl-flex sl-overflow-y-auto sl-flex-col sl-sticky sl-inset-y-0 sl-pt-8 sl-bg-canvas-100 sl-border-r custom-sidebar-main"
    ...
    <div class="sl-flex sl-overflow-y-auto sl-flex-col sl-flex-grow sl-flex-shrink">
        <div class="sl-overflow-y-auto sl-w-full sl-bg-canvas-100 custom-sidebar-menu">
            <div class="sl-my-3">
                @foreach($headings as $h1)
                    <div class="expandable">
                        <div title="{!! $h1['name'] !!}" id="toc-item-{!! $h1['slug'] !!}"
                             class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-4 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none custom-menu-input">
                            <a href="#{!! $h1['slug'] !!}"
                        ...
                        @if(count($h1['subheadings']) > 0)
                            <div class="children" style="display: none;">
                                @foreach($h1['subheadings'] as $h2)
                                    <div class="expandable">
                                        @php
                                            $h2Method = explode(' ', $h2['name'])[0] ?? null;
                                            $h2MethodClass = match($h2Method) {
                                                'GET' => 'method-bg-get',
                                                'POST' => 'method-bg-post',
                                                'PUT' => 'method-bg-put',
                                                'DELETE' => 'method-bg-delete',
                                                'PATCH' => 'method-bg-patch',
                                                default => '',
                                            };
                                        @endphp
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none {{ $h2MethodClass }}"
                                             id="toc-item-{!! $h2['slug'] !!}">
                                        ...
                                        @if(count($h2['subheadings']) > 0)
                                            <div class="children" style="display: none;">
                                                ...
                                                @php
                                                    $h3Method = explode(' ', $h3['name'])[0] ?? null;
                                                    $h3MethodClass = match($h3Method) {
                                                        'GET' => 'method-bg-get',
                                                        'POST' => 'method-bg-post',
                                                        'PUT' => 'method-bg-put',
                                                        'DELETE' => 'method-bg-delete',
                                                    ...
                                                    <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                       href="#{!! $h3['slug'] !!}">
                                                        <div title="{!! $h3['name'] !!}" id="toc-item-{!! $h3['slug'] !!}"
                                                             class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-12 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none {{ $h3MethodClass }}">
                                                            {!! $h3['name'] !!}
                                                        </div>
                                                    </a>
                                                @endforeach
        ...
        <div class="sl-flex sl-items-center sl-px-4 sl-py-3 sl-border-t custom-border-top">
