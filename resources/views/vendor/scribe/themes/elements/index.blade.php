...
<head>
    ...
    @endif
    {{-- My css --}}
    <link rel="stylesheet" href="{{ asset('css/scribe-custom-sidebar.css') }}">
    <link rel="stylesheet" href="{{ asset('css/scribe-custom-theme.css') }}" >
</head>
...
<div class="sl-elements sl-antialiased sl-h-full sl-text-base sl-font-ui sl-text-body sl-flex sl-inset-0">
    ...
    <div class="sl-overflow-y-auto sl-flex-1 sl-w-full sl-px-16 sl-bg-canvas sl-py-16 custom-main-block" style="max-width: 1500px;">
