...
/**
 * @group CosmoShop
 * @subgroup UnitOfMeasurment
 */
class UnitOfMeasurmentController extends Controller
{
    public $tableName = 'shopeinheiten';
    public $availableDatabases;
    public $database;
    public $pk = 'id';
    public $mapping = [
        'unit_id' => 'id',
        'internal_name' => 'name_intern'
    ];
    ...
    public function create(Request $request) {
        $validated = $request->validate([
            'internal_name' => 'required|string|max:250'
        ]);
        $mappedData = [];
